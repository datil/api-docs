...
descuento_adicional | float | Additional discount applied to the invoice subtotal, expressed in monetary value. <span style="color: red">__Deprecated__</span> *uses the additional_discount parameter of Total Tax section*
